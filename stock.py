...
class stock_picking(osv.osv):
    ...
    _columns = {
        'ship_method_id': fields.related('sale_id', 'ship_method_id', string='Name', type='many2one',
            relation='shipping.rate', store = {'sale.order': (_get_sale_order, ['ship_method_id'], -10)})
    }
...
class stock_move(osv.osv):
    ...
    _columns = {
        'ship_method_id': fields.related('picking_id', 'sale_id', 'ship_method_id', string='Name', type='many2one',
            relation='shipping.rate', store = {'sale.order': (_get_sale_order, ['ship_method_id'], -10)})
    }
